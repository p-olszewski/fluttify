    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              isLoginPage ? "Sign in to fluttify" : "Create Account",
            ...
            ElevatedButton(
              onPressed: () async {
                bool shouldRedirect = isLoginPage
                ...
                if (shouldRedirect) {
                  Fluttertoast.showToast(
                    msg: isLoginPage ? "Logged in" : "Account created",
                  );
                  if (!mounted) return;
                  Navigator.push(
                    context,
              ...
              child: Text(
                isLoginPage ? "Sign in" : "Register and login",
            ...
            TextButton(
              ...
              child: Text(
                isLoginPage ? "go to registration page" : "go back to the login page",
